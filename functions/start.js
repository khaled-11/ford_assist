...
module.exports = async () => {
  ...
  try{
        ...
        .on('end', async function() {
            ...
            var url = `https://api.mps.ford.com/api/fordconnect/vehicles/v1/${cre_data.vehicleId}/startEngine`
            await axios.post(url,"", {
                ...
                var url = `https://api.mps.ford.com/api/fordconnect/vehicles/v1/${cre_data.vehicleId}/startEngine/${response.data.commandId}`
                axios.get(url, {
                    headers: { 
                      "Content-Length":"0",
                      "Accept":"*/*",
